...
var ELEM_TO_ENTITY = {
  a: function a(tagName, element) {
    ...
    if (data.url != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.LINK, 'MUTABLE', data);
    }
  },
  img: function img(tagName, element) {
    ...
    if (data.fileId != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.IMAGE, 'IMMUTABLE', data);
    }
  },
  video: function video(tagName, element) {
    ...
    // Don't add `<img>` elements with no src.
    if (data.fileId != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.VIDEO, 'IMMUTABLE', data);
    }
  },
  audio: function audio(tagName, element) {
    ...
    // Don't add `<img>` elements with no src.
    if (data.fileId != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.AUDIO, 'IMMUTABLE', data);
    }
  },
  document: function document(tagName, element) {
    var data = getEntityData(tagName, element);
    // Don't add `<img>` elements with no src.
    if (data.fileId != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.DOCUMENT, 'IMMUTABLE', data);
    }
  },
  iframe: function iframe(tagName, element) {
    var data = getEntityData(tagName, element);
    // Don't add `<img>` elements with no src.
    if (data.sec != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.YOUTUBE, 'IMMUTABLE', data);
    }
  },
  div: function div(tagName, element) {
    var data = getEntityData(tagName, element);
    // Don't add `<img>` elements with no src.
    if (data.src != null) {
      return _draftJs.Entity.create(ENTITY_TYPE.HYPERLINK, 'IMMUTABLE', data);
    }
  }
};
...
var SELF_CLOSING_ELEMENTS = { img: 1, video: 1 };
